...
[![x-cmd/install — rustfs Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/rustfs.svg?lang=zh)](https://x-cmd.com/install/rustfs)
...
合计: **1,396,264** 行代码（覆盖前 5 种语言、共 **2268** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 1,303,128 | 56,188 | 135,763 | 1904 |
| Sh | 43,456 | 2,635 | 5,516 | 166 |
| Python | 28,978 | 308 | 2,975 | 64 |
| Json | 12,592 | 0 | 0 | 75 |
| Toml | 3,819 | 929 | 387 | 59 |

## 源代码

- **上游仓库**: <https://github.com/rustfs/rustfs>
- **官网**: <https://rustfs.com/download/>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `1.0.1-preview.10` (2026-09-16)
- **最近提交**: 2026-09-24
- **Release 含资产**: 20 个

## 流行度

- **Star**: 33,737 · **Fork**: 1,508 · **开放 issue**: 1,868 · **贡献者**: 181

## 累计统计

- **发布数**: 129 · **已合并 PR**: 5588 · **开放 PR**: 9 · **已关闭 issue**: 1839 · **开放 issue**: 29 · **提交数**: 6814

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 12 | 1197 | 9 | 213 | 22 | 785 |
| last60d | 2026-07-26 | 17 | 2254 | 9 | 389 | 25 | 1877 |
| 90d | 2026-06-26 | 23 | 3434 | 9 | 538 | 26 | 2987 |
| last180d | 2026-03-28 | 40 | 4624 | 9 | 872 | 28 | 4161 |
| 360d | 2025-09-29 | 70 | 5357 | 9 | 1598 | 29 | 4909 |
| last720d | 2024-10-04 | 100 | 5588 | 9 | 1839 | 29 | 6529 |
...
rustfs 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `rustfs` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/rustfs.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:37:01Z._
